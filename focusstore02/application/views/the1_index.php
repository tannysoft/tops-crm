...
*/ ?>
    ...
    <script>
      ...
      if(sblCookie!==null) {
        window.location.href = "https://crm.tops.co.th/data/46/sid/" + sblCookie;
      }
      ...
      $("#theoneForm").submit(function(e) {
        ...
        if(phoneLength !== 10 && phoneLength !== 16) {
          ...
          var url = 'https://crm.tops.co.th/data/getCustomerProfile/46/' + phone;
          ...
          request.onload = function() {
            if (request.status >= 200 && request.status < 400) {
              ...
              if(resp.code==200 && resp.message == "success to get target customer profile") {
                ...
                window.location.href = "https://crm.tops.co.th/data/46/sid/" + resp.data.sblMemberId;
              } else {
                window.location.href = "https://crm.tops.co.th/focusstore02/mass";
              }
            } else {
