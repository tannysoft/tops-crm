  ...
  <body>
    <div class="app">
      ...
      <div class="tops-highlight">
          <div class="container">
              <div class="front">
                  <img src="<?php echo base_url(); ?>assets/img/trgfeb2019-th.jpg" id="front-image" alt="Banner" />
              </div>
          </div>
      </div>
      <div class="clear"></div>
...
*/ ?>
      <div id="cpn2-content" class="tops-card d-none">
          <div class="container">
              ...
              <div class="promo -no-side -space-top">
                  ...
                  <div class="more-condition">
                      ...
                      <div class="condition-detail">
                        <ul class="modal-th d-none">
                          ...
                          <li>คูปองส่วนลดนี้สามารถใช้ร่วมกับคูปองส่วนลดอื่นได้ หากยอดซื้อของใบเสร็จนั้น มากกว่าหรือเท่ากับยอดซื้อตามเงื่อนไขของแต่ละคูปองรวมกัน</li>
                          <li>คูปองนี้ใช้เป็นส่วนลดสำหรับสมาชิกเดอะวัน และใช้ได้เพียง 1 ครั้ง /ใบเสร็จ ที่เซ็นทรัล ฟู้ด ฮอลล์ และท็อปส์ทุกสาขา</li>
                        ...
                        <ul class="modal-en d-none">
                          ...
                          <li>This discount coupon can be used with other coupons had the purchase price in the receipt is greater than or equal to the purchase price of all coupons combined.</li>
                          <li>This coupon can be used once/receipt with The 1 members at Central Food Hall and Tops.</li>
                          <li>This coupon cannot be exchanged or redeemed for cash.</li>
              ...
              <div class="promo -no-side -no-side-wide">
                  ...
                  <div class="more-condition">
                      ...
                      <div class="condition-detail">
                        ...
                        <ul class="modal-en d-none">
                          <li>This coupon can be used to get discount at branches of Central Food Hall and Tops hat have this item available.</li>
      ...
      <footer class="tops-footer">
          <div class="container">
              <img src="<?php echo base_url(); ?>assets/img/tops-footer.png" alt="Tops" />
          </div>
      </footer>
    </div>
    ...
    <script>
      ...
      request.open('GET', serverUrl + 'data/40/' + unique_id, true);
...
/*
          ...
          if(resp.data.barcodes.GPRO) {
            ...
            $.each(resp.data.barcodes.GPRO, function (key, value) {
              ...
              var classUsed = null;
              if(value.used == true) {
                htmlUsed = "<div class='stamp'><img src='" + serverUrl + "trgfeb2019/assets/img/icon-used.svg' alt='stamp' /></div>";
...
*/ ?>
          ...
          $( ".btn-confirm" ).click(function(e) {
            ...
            $(".bar-display[data-customer='" + data_customer + "'][data-barcode='" + data_barcode + "']").append("<div class='stamp'><img src='" + serverUrl + "trgfeb2019/assets/img/icon-used.svg' alt='stamp' /></div>").addClass("coupon-used");
            $( '#barcode-type' ).html( data_type );
            $( '#barcode-image' ).html( "<img src='" + serverUrl + 'trgfeb2019/assets/barcode/' + data_barcode + ".png' alt='barcode' />" );
...
<?php
            /*$( this ).append("<div class='stamp'><img src='" + serverUrl + "trgfeb2019/assets/img/icon-used.svg' alt='stamp' /></div>");
            $( this ).addClass("coupon-used");
            
            var customer_id = $( this ).attr("data-customer");
            var barcode_number = $( this ).attr("data-barcode");
            $( '#barcode-image' ).html( "<img src='" + serverUrl + 'trgfeb2019/assets/barcode/' + barcode_number + ".png' alt='barcode' />" );
...
*/ ?>
      ...
      function sendUseCoupon(respId, conditionId) {
        ...
        requestCoupon.open('GET', serverUrl + 'coupon_click/40/' + respId + '/' + conditionId, true);
