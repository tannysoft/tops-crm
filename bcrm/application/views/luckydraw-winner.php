...
<div class="wrapper">
	<header id="coupon">
		<div class="coupon-container<?php echo ($used || $expired || $exceeded) ? ' coupon-disabled' : NULL ?>">
			<img class="img-fluid" src="<?php echo base_url('assets/coupon/voucher.png') ?>" alt="<?php echo $coupon->barcode ?>">
		</div>
...
$(function(){
	...
	$('#apply').click(function(){
		...
		condition.find('.btn-confirm').click(function(){
			...
			var endpoint = '<?php echo site_url('api/luckydraw-voucher-used') ?>';
