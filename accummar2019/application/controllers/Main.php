...
class Main extends CI_Controller {
	...
	public function contentActive()
	{
		$this->load->view('content_active');
	}

	public function contentFamily()
	{
		$this->load->view('content_family');
	}

	public function contentSenior()
	{
		$this->load->view('content_senior');
	}

	public function contentActiveEN()
	{
		$this->load->view('content_active_en');
	}
/*
